...
export async function generateTokenImage(imagePrompt, symbol, tokenName) {
  ...
  const enhancedPrompt = `${imagePrompt}, cute cartoon animal mascot, meme coin art style, vibrant saturated colors, fun expressive character, crypto themed, pump.fun aesthetic, clean white background, high quality digital illustration, adorable expression`;
