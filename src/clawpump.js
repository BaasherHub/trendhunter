...
/**
 * Step 1: Upload the token image to ClawPump
 */
...
/**
 * Step 2: Launch the token on ClawPump / pump.fun
 */
...
/**
 * Check platform treasury health
 */
export async function checkTreasury() {
  const response = await axios.get(`${BASE_URL}/api/treasury`, {
    timeout: 10000,
  });
  return response.data;
}
